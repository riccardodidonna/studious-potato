...
int main()
{
    int ga,ma,aa,gn,mn,an,mdiff,gdiff=0,ng=0;  //ga,ma,aa -> giorno mese anno ATTUALI --- gn,mn,an -> giorno mese anno NASCITA
    cout <<"Inserisci giorno, mese e anno attuale (GG ↵ MM ↵ AAAA): "<<endl;
    cin>>ga>>ma>>aa;
    cout <<"Inserisci giorno, mese e anno di nascita (GG ↵ MM ↵ AAAA): "<<endl;
    cin>>gn>>mn>>an;
